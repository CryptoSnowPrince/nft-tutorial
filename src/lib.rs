...
const TOKEN_METADATA_BASE_URL: &str = "https://ipfs.io/ipfs/QmQ6dohUoa9aNSbzw8Z69nj7UM1gqFvbt92mLAf46YxAiL";
...
#[init(contract = "nft_tutorial", event = "Cis2Event<ContractTokenId, ContractTokenAmount>")]
...
/// testing.
#[receive(contract = "nft_tutorial", name = "view", return_value = "ViewState")]
